...
Public Class Student_MeetingSetup
...
#Region "loaddata"
    ...
    Protected Sub ddlProject_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlProject.SelectedIndexChanged
        SQL(0) = "  Select teamtitle from team a inner join teamenrol b On a.teamId = b.teamId  " _
                 & " inner join enrolment c On c.enrolId = b.enrolId  where c.stuId = " _
                 & Session("userId") _
                 & " And a.projId = " _
    ...
    Sub loaddata()
        SQL(0) = " Select *, DATE_FORMAT(a.meetingDate,'%d/%m/%Y') AS dateStr " _
                ...
                & " And a.meetingType <> 'Supervisor meeting' " _
...
#End Region
    ...
    Protected Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        SQL(0) = "  Select a.teamId from team a inner join teamenrol b On a.teamId = b.teamId  " _
                 & " inner join enrolment c On c.enrolId = b.enrolId  where c.stuId = " _
                 & Session("userId") _
                 & " And a.projId = " _
                 & ddlProject.SelectedValue
        ...
        cmd.Parameters.AddWithValue("@pmeetingType", "Team meeting")
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        SQL(0) = " Select *, DATE_FORMAT(a.meetingDate,'%d/%m/%Y') AS dateStr " _
                ...
                & " Join team b on a.teamId = b.teamId " _
                & " Join project c On b.projId = c.projId " _
                & " join teamEnrol e On e.teamId = b.teamId " _
                & " join enrolment d On e.enrolId = d.enrolId  " _
                & " Where c.offUnitId = " & Session("offUnitId") & " " _
                & " And d.stuId = '" & Session("userId") & "' " _
                & searchTerm _
                & " And a.meetingType <> 'Supervisor meeting' " _
