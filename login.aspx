                        ...
                        <div class="col-xl-10 col-lg-12 col-md-9">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">
                                   Please enter your Student ID or Staff SIMS ID to Sign In.
                                </h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
                                <form runat="server">
                                    <center>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:TextBox ID="txtPwd" class="form-control" runat="server" TextMode="Password"></asp:TextBox>
                                            </div>
                                        </div>
                                        <asp:Button ID="btnSave" class="btn btn-primary" runat="server" Text="Sign In" />
                                    </center>
                                </form>
                            </div>
                            </div>
